...
<div class="layout ws10 mac content afcf yonghuBox">
  <div class="mt30 bc2box br10 p30 ofh">
    ...
    <!-- 用户密码 -->
      <form class="form" action="/sca/index.php/Personal/modifypass_personal/uid/10218.html" method="POST" id="form1">
        <div><span>修改密码</span><a style="float: right;margin-right:2%;" class="fr bc3box pt5 pb5 pl20 pr20 fs14 tac br3" href="<?php echo U('Manage/info_manage');?>">返回</a></div>
        <table cellspacing="0" cellpadding="5" class="mt20">
          ...
          <!-- <tr>
            ...
            <td class="pl10"><img src="/sca/index.php/Home/Layout/captcha" onclick="javascript:this.src = this.src +'?' + Math.random();" id='clickpic' style="width: 48%;" /></td>
            <td class="pl10" style="width:20%;"><span id="captchainfo" style="color:red;">&nbsp;</span></td>
          </tr> -->
          <tr>
            <td></td>
            <td class="pl10 pt20"><input type="button" class="ws12 bc3box p5 fs14 fcf tac db br3 bdn" value="修改密码" id="formsubmit1" /></td>
            <td></td>
          </tr>
        </table>
      </form>
