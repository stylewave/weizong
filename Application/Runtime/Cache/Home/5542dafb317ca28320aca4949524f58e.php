...
<div class="layout ws10 mac content afcf settingBox">
  <div class="mt30 bc2box br10 p30 ofh">
    ...
    <div class="ws10 fr bdl9 pl30 sright">
      <div class="ofh"><span class="fl fs16 fwb pt5">修改PDF拓展信息</span><a class="fr bc3box pt5 pb5 pl20 pr20 fs14 tac br3" href="/sca/index.php/Home/Manage/pdfext_list">返回</a></div>
      <form class="form" action="/sca/index.php/Home/Manage/pdfext_set/pdfextid/1" method="post" enctype="multipart/form-data" >
      <table cellspacing="0" cellpadding="5" class="mt20">
        <tr>
          <td class="tar">头部上方内容</td>
          <td class="pl10"><input class="ws12 wzh_input p5 bcn bd9 fcf" type="text" name="headerup" value="<?php echo ($pdfextinfo["headerup"]); ?>"/></td>
          <td class="pl10" id="headcontenttip"></td>
        </tr>
        <tr>
          <td class="tar">头部下方内容</td>
          <td class="pl10"><input class="ws12 wzh_input p5 bcn bd9 fcf" type="text" name="headerdown" value="<?php echo ($pdfextinfo["headerdown"]); ?>"/></td>
          <td class="pl10" id="footcontenttip"></td>
        </tr>
        <tr>
          <td class="tar">头部图片</td>
           <td class="pl10"><input  type="file" name="headimg" /></td>
          <td><img src="/sca/<?php echo ($pdfextinfo["headimg"]); ?>" width="30px" /></td>
        </tr>
        <tr>
          <td class="tar">背景图片</td>
          <td class="pl10"><input  type="file" name="background" /></td>
          <td><img src="/sca/<?php echo ($pdfextinfo["background"]); ?>" width="30px" /></td>
        </tr>
        <tr>
          <td class="tar">验证码</td>
        ...
        <tr>
          <td></td>
          <td class="pl10 pt20"><input type="button" class="ws12 bc3box pt8 pb8 fs14 fcf tac db br3 bdn" value="更新资料" onclick="pdfextset()" /></td>
          <td></td>
        </tr>
      </table>
      </form>
...
<script src="/sca/Public/js/pdfext.js"></script>
</html>