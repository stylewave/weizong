...
<div class="mt30 bc2box br10 p30 ofh">
    ...
    <div class="ws10 fr bdl9 pl30 pr30 sright">
      <!-- 用户信息 -->
       <form class="form" action="/sca/index.php/Personal/modifyinfo_personal/uid/10218.html" method="POST" id="form2">
        <div class="fs16 fwb"><span>修改用户信息</span><a style="float: right;margin-right:2%;" class="fr bc3box pt5 pb5 pl20 pr20 fs14 tac br3" href="<?php echo U('Manage/info_manage');?>">返回</a></div>
        <table cellspacing="0" cellpadding="5" class="mt20">
          ...
          <tr>
            ...
            <td class="pl10"><span id="jobinfo" style="color:red;">&nbsp;</span></td>
          </tr>
          <tr>
            <td class="tar nwp">姓名</td>
            <td class="pl10"><input class="ws12 wzh_input p5 bcn bd9 fcf" type="text" name="username" value="<?php echo ($info['realname']); ?>"/></td>
            <td class="pl10"><span id="usernameinfo"  style="color:red;">&nbsp;</span></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="pl10"><input class="ws12 wzh_input p5 bcn bd9 fcf" type="text" name="address" value="<?php echo ($info['address']); ?>"/></td>
            <td class="pl10"><span style="color:red;">&nbsp;</span></td>
          </tr>
          <tr>
            <td class="tar nwp">开发者类型</td>
            <td class="pl10"><input  type="radio" value='0' name="dvrtype" <?php if($info['dvrtype'] == '0'): ?>checked="checked"<?php endif; ?> />个人<input  type="radio" value="1" name="dvrtype" <?php if($info['dvrtype'] == '1'): ?>checked="checked"<?php endif; ?> />企业</td>
            <td class="pl10">&nbsp;</td>
            <td class="pl10" width="40%">&nbsp;&nbsp;</td>
          </tr>
          <tr>
            <td></td>
            <td class="pl10 pt20"><input type="button" class="ws12 bc3box p5 fs14 fcf tac db br3 bdn" value="修改用户信息" id="formsubmit2" /></td>
            <td><font id="personalErrorInfo" color="red"></font></td>
          </tr>
        </table>
      </form>
    </div>
