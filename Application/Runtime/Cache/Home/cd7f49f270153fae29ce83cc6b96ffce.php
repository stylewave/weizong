...
<div class="layout ws10 mac content afcf settingBox">
  <div class="mt30 bc2box br10 p30 ofh">
    ...
    <div class="ws10 fr bdl9 pl30 sright">
      <div class="ofh"><span class="fl fs16 fwb pt5">修改应用前缀</span><a class="fr bc3box pt5 pb5 pl20 pr20 fs14 tac br3" href="/sca/index.php/Home/Vocationtype/list_vocationtype">返回</a></div>
      <form class="form" action="/sca/index.php/Home/Vocationtype/update_vocationtype/typeid/1" method="POST" id="form">
      <table cellspacing="0" cellpadding="5" class="mt20">
        <tr>
          <td class="tar">前缀英文名</td>
          <td class="pl10"><input class="ws12 wzh_input p5 bcn bd9 fcf" type="text" name="vocationtype" value="<?php echo ($appTypeInfo["vocationtype"]); ?>"/></td>
          <td></td>
        </tr>
        <tr>
          <td class="tar">前缀中文名</td>
          <td class="pl10"><input class="ws12 wzh_input p5 bcn bd9 fcf" type="text" name="zhvocationtype" value="<?php echo ($appTypeInfo["zhvocationtype"]); ?>"/></td>
          <td class="pl10" id="zhvocationtypetip"></td>
        </tr>
        <tr>
          <td class="tar">前缀介绍</td>
          <td class="pl10"><input class="ws12 wzh_input p5 bcn bd9 fcf" type="text" name="info" value="<?php echo ($appTypeInfo["info"]); ?>"/></td>
          <td></td>
        </tr>
        <tr>
          <td class="tar">验证码</td>
        ...
        <tr>
          <td></td>
          <td class="pl10 pt20"><input type="button" class="ws12 bc3box pt8 pb8 fs14 fcf tac db br3 bdn" value="更新资料" onclick="updateVocationtype()" /></td>
          <td></td>
        </tr>
      </table>
      </form>
...
<script src="/sca/Public/js/updateVocationtype.js"></script>
</html>